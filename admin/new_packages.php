 ...
 <div class="container">
    ...
    // </script>";
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO packages (package_name, package_min, package_max, package_interest) VALUES (?,?,?,?)";
            $stmp = $connection->prepare($sql);
            $stmp->bind_param("ssss", $package_name, $package_min, $package_max, $package_interest);
            if ($stmp->execute()) {
                echo "<script>
