                    ...
                    <?php
                                // approve packages end 
                                    if (isset($_GET['approve'], $_GET['a_id'], $_GET['amount'], $_GET['name'], $_GET['mode'], $_GET['type'])) {
                                        ...
                                        if ($connection->query($sql)===TRUE) {
                                            ...
                                            $u_sql = "UPDATE users SET balance = balance WHERE user_id = '$the_approve'";
                                            if ($connection->query($u_sql)===TRUE) {}

                                                // send mail
                                            $to = "$db_email";
                                            $subject = "Withdrawal Request {$date}";
                                            $message = "
                                            ...
                                            <p>Hi <b>$the_name</b></p>
                                            <p>Your Pending Withdrawal of $d_amount USD has been <b>approved</b></p>
                                            <br>
                                            <p>Thanks</p>
                        ...
                        ?>
							<tr>
                                ...
                                <td style='background: var(--dark)'>
                                    <a href="withdraw?approve=<?php echo $id?>&a_id=<?php echo $t_id?>&amount=<?php echo $transaction_amount?>&name=<?php echo $name?>&mode=<?php echo $t_mode?>&type=<?php echo $eth?>"><button>Approve</button></a>
                                    <a href="withdraw?pending=<?php echo $id?>&p_id=<?php echo $t_id?>"><button style='margin: 3px 0'>Pending</button></a>
                                    <a href="withdraw?Rejected=<?php echo $id?>&p_id=<?php echo $t_id?>"><button style='margin: 3px 0'>Reject</button></a>
                                </td>
							</tr>
                            <?php }?>
					</tbody>
